...
<section className="relative bg-[#E3DBD1] overflow-hidden">
  ...
  <div className="absolute bottom-0 right-0 w-80 h-80 bg-[#C14E29]/15 rounded-full blur-3xl"></div>

  <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 text-center">

    {/* Texto pequeño */}
    <p className="uppercase tracking-[0.4em] text-[#C14E29] text-sm font-semibold mb-6">
      INVITACIÓN DE BODA
    </p>

    {/* Nombres */}
    <h1 className="font-cursiveDancing text-[#7B7A42] text-5xl sm:text-6xl md:text-7xl leading-tight">
      ¡Estás Invitado!
    </h1>


    {/* Mensaje */}
    <p className="mt-10 text-[#7B7A42] text-lg sm:text-xl md:text-2xl leading-relaxed max-w-3xl mx-auto">
